...
import { COUNT_RANDOM_POSTS, posts as generatedPosts } from './data.js';
import { posts as receivedPosts } from './loadPosts.js';
...
const rerender = debounce((id) => {
  ...
  switch (id) {
    case 'filter-random':
      postsCurrent = shuffle(posts.slice()).slice(0, COUNT_RANDOM_POSTS);
      break;
